...
namespace Cosmos.Core.Extension
{
    ...
    public static class EntityProperties
    {
        ...
        /// <returns></returns>
        public static HttpResponse ValidationEntityList<T>(this List<T> entityList, Expression<Func<T, object>> expression = null)
        {
        ...
        /// <returns></returns>
        public static HttpResponse ValidationEntity<T>(this T entity, Expression<Func<T, object>> expression = null, Expression<Func<T, object>> validateProperties = null)
        {
        ...
        /// <returns></returns>
        public static HttpResponse ValidationEntity<T>(this T entity, string[] specificProperties, string[] validateProperties = null)
        {
            HttpResponse responseData = new HttpResponse();
